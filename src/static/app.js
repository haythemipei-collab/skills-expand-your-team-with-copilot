document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    ...
    try {
      ...
      // Note: According to requirements, "All" option should only show activities
      // with no specified difficulty, so we don't send difficulty param when empty
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // Apply difficulty filter for "All" option
      // According to requirements: "All" option should only show activities with no specified difficulty
